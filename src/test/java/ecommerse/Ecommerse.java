...
public class Ecommerse {
	...
	public void signupandlogin() throws Exception {
		...
		// Code for Sign-Up and Login functionality
	...
	public void navigationofallMenu() throws Exception {
		...
		// Navigation through all menus and title validation

		WebElement menu = driver.findElement(By.linkText("Top Deals"));
		menu.click();

		String pageTitle = driver.getTitle();
		Assert.assertEquals(pageTitle, "Top Deals and Featured Offers on Electronics - Best Buy");

		WebElement menu2 = driver.findElement(By.linkText("Deal of the Day"));
		menu2.click();

		String pageTitle2 = driver.getTitle();
		Assert.assertEquals(pageTitle2, "Deal of the Day: Electronics Deals - Best Buy");

		WebElement menu3 = driver.findElement(By.linkText("My Best Buy Memberships"));
		menu3.click();

		String pageTitle3 = driver.getTitle();
		Assert.assertEquals(pageTitle3, "My Best Buy Memberships");

		WebElement menu4 = driver.findElement(By.linkText("Credit Cards"));
		menu4.click();

		String pageTitle4 = driver.getTitle();
		Assert.assertEquals(pageTitle4, "Best Buy Credit Card: Rewards & Financing");

		WebElement menu5 = driver.findElement(By.linkText("Black Friday Deals"));
		menu5.click();

		String pageTitle5 = driver.getTitle();
		Assert.assertEquals(pageTitle5, "Best Buy Black Friday 2023 Deals");
	...
	public void validatethebottomlink() throws Exception {
		...
		// To validate bottom links on the homepage
	...
	public void searchfor() throws Exception {
		...
		// Click on the first search result to add to cart
		Thread.sleep(5000);
	...
	public void shopbyDepartment() throws Exception {
		...
		// Navigate to Shop by Department
	...
	public void selectAnyBrand() throws Exception {
		...
		Thread.sleep(4500);
		WebElement closepopup = driver.findElement(By.xpath("//a[normalize-space()='Go to Cart']"));
		closepopup.click();
	...
	public void checkout() throws Exception {
		...
		WebElement apply = driver.findElement(
				By.xpath("//button[@class='c-button c-button-secondary c-button-md new-address-form__button']"));
		apply.click();

		WebElement keepanaddress = driver
				.findElement(By.xpath("//div[contains(@class,'standardization-body-fu2021')]//button[1]"));
		keepanaddress.click();
		...
		// submit the form by filling mandatory detailes
	...
	public void orderwasplaced() throws Exception {
		...
		// Verify order confirmation message on the resulting web page

		WebElement creditcardnumber = driver.findElement(By.xpath("//input[@id='number']"));
		creditcardnumber.sendKeys("7363562467249834");

		WebElement placeyourorder = driver.findElement(By.xpath("//button[@class='btn btn-lg btn-block btn-primary']"));
